...
def createWKTField(layer, fieldName = 'wkt', expressionQGis = 'geom_to_wkt($geometry)', type = QVariant.String):
    """
    ...
    pr.addAttributes([QgsField(fieldName, type)])
    layer.updateFields()
...
def exportRaster(file_out_name, file_out_full_path, layer):
    file_out_full_path = file_out_full_path + file_out_name + '.tif'
